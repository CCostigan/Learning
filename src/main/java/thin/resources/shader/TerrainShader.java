...
extends AbstractShaderProg {
    ...
    private static final String vertfilename = "src/main/res/glsl/terrain_vert_shader.glsl";
    private static final String fragfilename = "src/main/res/glsl/terrain_frag_shader.glsl";
